...
# Morning prayer list
morning_prayer_list = defaultdict(dict)
...
add_ichthys_prayer_list_to_prayer_list_dict(morning_prayer_list , config.pray_through_ichthys_prayer_list_in_x_days)
...
# Evening prayer list
evening_prayer_list = defaultdict(dict)
